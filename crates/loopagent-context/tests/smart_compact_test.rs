use loopagent_context::middleware::SmartCompact;
use loopagent_types::message::{ContentBlock, Message};
...
async fn smart_compact_with_tool_io_messages() {
    ...
    let tool_use_msg = Message {
        role: loopagent_types::message::MessageRole::Assistant,
    ...
    let tool_result_msg = Message {
        role: loopagent_types::message::MessageRole::User,
