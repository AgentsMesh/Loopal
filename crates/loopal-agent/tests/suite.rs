...
#[path = "suite/bridge_child_failure_test.rs"]
mod bridge_child_failure_test;
#[path = "suite/bridge_child_test.rs"]
mod bridge_child_test;
#[path = "suite/config_branch_test.rs"]
mod config_branch_test;
...
#[path = "suite/task_patch_branch_test.rs"]
mod task_patch_branch_test;
