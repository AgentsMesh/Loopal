...
fn preflight_truncation_reduces_token_estimate() {
    use loopagent_context::compaction::{find_largest_tool_result, truncate_block_content};
    use loopagent_context::token_counter::estimate_messages_tokens;
...
fn preflight_compact_fallback_with_no_tool_results() {
    ...
    use loopagent_context::compaction::find_largest_tool_result;
