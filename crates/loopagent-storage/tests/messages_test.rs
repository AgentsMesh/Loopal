use loopagent_storage::MessageStore;
...
fn test_load_messages_preserves_roles() {
    ...
    assert_eq!(messages[0].role, loopagent_types::message::MessageRole::User);
    assert_eq!(messages[1].role, loopagent_types::message::MessageRole::Assistant);
    assert_eq!(messages[2].role, loopagent_types::message::MessageRole::System);
}
