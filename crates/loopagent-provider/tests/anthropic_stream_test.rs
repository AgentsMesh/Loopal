...
fn assert_text(chunk: &Result<StreamChunk, LoopAgentError>, expected: &str) {
    match chunk {
...
fn assert_tool(chunk: &Result<StreamChunk, LoopAgentError>, exp_id: &str, exp_name: &str) {
    match chunk {
...
fn assert_usage(chunk: &Result<StreamChunk, LoopAgentError>, exp_in: u32, exp_out: u32) {
    match chunk {
