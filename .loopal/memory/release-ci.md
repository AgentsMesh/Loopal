...
v0.4.0 (tag dated 2026-05-08)

Version lineage: v0.0.1-alpha → v0.0.1-alpha.1 → v0.0.1-alpha.2 → v0.1.0 → v0.1.1 → v0.2.0 → v0.3.0 → v0.4.0

## Release Pipeline

Builds 4 platform targets in `/Users/stone/Works/Loopal/.github/workflows/release.yml`:
- macOS ARM64
- Linux ARM64
- Linux x86_64
- Windows x86_64

Last measured wall-clock time: ~17 minutes; Windows was the bottleneck at ~16m15s. Re-check timings after Windows/rules_rust changes (see `windows-ci-gotchas.md`).
