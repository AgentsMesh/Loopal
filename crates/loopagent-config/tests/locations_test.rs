...
fn test_project_config_dir() {
    ...
    assert_eq!(result, Path::new("/home/user/project/.loopagent"));
}
...
fn test_project_settings_path() {
    ...
    assert_eq!(
        result,
        Path::new("/home/user/project/.loopagent/settings.json")
    );
}
...
fn test_project_local_settings_path() {
    ...
    assert_eq!(
        result,
        Path::new("/home/user/project/.loopagent/settings.local.json")
    );
}
...
fn test_project_instructions_path() {
    ...
    assert_eq!(result, Path::new("/home/user/project/LOOPAGENT.md"));
}
...
fn test_global_config_dir_returns_home_based_path() {
    ...
    assert!(path.ends_with(".loopagent"));
}
...
fn test_global_settings_path_returns_json_file() {
    ...
    assert!(path.to_string_lossy().contains(".loopagent"));
}
...
fn test_global_instructions_path_returns_md_file() {
    ...
    assert!(result.is_ok());
    let path = result.unwrap();
    assert!(path.ends_with("LOOPAGENT.md"));
    assert!(path.to_string_lossy().contains(".loopagent"));
}
