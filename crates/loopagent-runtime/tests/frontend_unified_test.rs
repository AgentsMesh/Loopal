use loopagent_runtime::frontend::{AutoDenyHandler, UnifiedFrontend};
...
fn make_unified(
    ...
    event_tx: mpsc::Sender<loopagent_types::event::AgentEvent>,
    mailbox_rx: mpsc::Receiver<Envelope>,
    control_rx: mpsc::Receiver<ControlCommand>,
    cancel_token: Option<CancellationToken>,
    handler: Box<dyn loopagent_runtime::frontend::PermissionHandler>,
) -> UnifiedFrontend {
