use loopagent_types::error::{
    AgentOutput, LoopAgentError, ProviderError, TerminateReason,
};
...
#[test]
fn test_loopagent_context_overflow_delegation() {
    let err = LoopAgentError::Provider(ProviderError::ContextOverflow {
