use loopagent_provider::AnthropicProvider;
use loopagent_types::message::{ContentBlock, ImageSource, Message, MessageRole};
use loopagent_types::provider::ChatParams;
